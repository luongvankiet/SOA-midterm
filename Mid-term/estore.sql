...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 23, 2018 lúc 06:09 PM
...
CREATE TABLE `orders` (
  ...
  `created_at` varchar(20) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `orders` (`orderID`, `userID`, `total`, `created_at`) VALUES
(1, 3, 1900, '2018-10-23'),
(2, 3, 7800, '2018-10-23');
...
INSERT INTO `order_detail` (`detailID`, `productID`, `orderID`, `quantity`, `unit_price`) VALUES
(1, 5, 1, 1, 1100),
(2, 6, 1, 1, 800),
(3, 7, 2, 4, 900),
(4, 10, 2, 1, 850),
...
INSERT INTO `products` (`prodID`, `prodName`, `prodDetail`, `image`, `prodQty`, `price`, `subCatID`) VALUES
(5, 'Apple iPhone X 64GB Space Grey', '<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n                consequat.Duis\r\n                aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.\r\n                Excepteur\r\n                sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\r\n              ', 'assets/images/ipX.jpg', 81, 1100, 7),
(6, 'Apple iPhone 7 Plus 128GB Jet Black', '<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n                consequat.Duis\r\n                aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.\r\n                Excepteur\r\n                sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\r\n              ', 'assets/images/ip7.jpg', 87, 800, 7),
(7, 'Samsung Galaxy Note 8 64GB RAM 6GB 6.3 inch', '<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n                consequat.Duis\r\n                aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.\r\n                Excepteur\r\n                sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\r\n              ', 'assets/images/sg-note8.jpg', 96, 900, 8),
(8, 'Samsung Galaxy S9 Plus 64GB RAM 6GB', '<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n                consequat.Duis\r\n                aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.\r\n                Excepteur\r\n                sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\r\n              ', 'assets/images/s9_1.jpg', 99, 950, 8),
(9, 'Apple iPad 2018 Wi-Fi 32GB', 'Màn hình Retina 9.7inch\r\nBộ vi xử lí A10 cho hiệu năng hoạt động mạnh mẽ\r\nROM 32GB\r\nCamera 8 MP, FaceTime với độ phân giải HD\r\nTouch ID\r\nHỗ trợ bút Apple Pencil\r\n\r\n', 'assets/images/LD0004850319_2.jpg', 200, 500, 9),
(10, 'Apple iPad Pro 10.5-inch Wi-Fi + Cellular 64GB Gold', 'Màn hình: IPS LCD, 10.5\"\r\nHệ điều hành: iOS 11\r\nCPU: Apple A10X 6 nhân 64-bit\r\nRAM: 4 GB\r\nBộ nhớ trong: 64 GB\r\nCamera sau: 12 MP\r\nCamera trước: 7 MP\r\nKết nối mạng: WiFi, 3G, 4G LTE\r\nHỗ trợ SIM\r\nNano Sim: HOTSIM VIETTEL DATA 7GB/tháng.\r\nĐàm thoại: FaceTime', 'assets/images/ipad-10.5inch.jpg', 99, 850, 9),
(11, 'Samsung Galaxy Tab A 8.0 T385 (Gold)- 16Gb/ 8.0Inch/ 4G + Wifi', '<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n                consequat.Duis\r\n                aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.\r\n                Excepteur\r\n                sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\r\n              ', 'assets/images/samsung-galaxy-tab-a80.jpg', 200, 450, 10),
(12, 'Máy tính xách tay/ Laptop Asus UX331UAL-EG020TS (i7-8550U) ', '- CPU: Intel Core i7-8550U (1.80 Ghz up to 4.00 Ghz, 8MB Cache)\r\n- RAM: 8GB LPDDR3 (Không nâng cấp)\r\n- Đồ họa: Intel UHD Graphics 620\r\n- Ổ cứng: SSD 512GB\r\n- Hỗ trợ khe cắm M.2: Không\r\n- Màn hình: 13\" (1920 x 1080), Webcam\r\n- Cổng giao tiếp: HDMI, USB Type-C, 2x USB 3.0\r\n- Wifi AC, Bluetooth 4.2, Finger print, Card reader, Led Keyboard\r\n- Khối lượng: 1.0 Kg, pin 3 cell\r\n- Hệ điều hành: Win 10 Home', 'assets/images/asus-zenbook-ux331ual-eg020ts-0.jpg', 200, 1100, 3);
...
(3, 'luongvankiet.1997@gmail.com', 'Luong Van Kiet', '123', '123456789', 'abcxyz');
...
--
ALTER TABLE `order_detail`
  MODIFY `detailID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
